...
import { RatingsController } from './api/ratings.controller';
...
import { PgRatingRepository } from './infra/db/pg-rating.repository';
...
@Module({
  ...
  controllers: [OrdersController, RatingsController],
  providers: [
    OrdersService,
    RatingsService,
    PgRatingRepository,
